...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("port", type=str, help="Device port. You can list all devices with list_devices command.")
        parser.add_argument("baud", type=int, help="Baudrate transmission with device.")
