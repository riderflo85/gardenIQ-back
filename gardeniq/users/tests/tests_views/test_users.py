...
class TestUserAPIModelViewList(ViewSetTestMixin):
...
@pytest.mark.django_db
class TestUserAPIModelViewRetrieve(ViewSetTestMixin):
...
@pytest.mark.django_db
class TestUserAPIModelViewCreate(ViewSetTestMixin):
...
@pytest.mark.django_db
class TestUserAPIModelViewUpdate(ViewSetTestMixin):
...
@pytest.mark.django_db
class TestUserAPIModelViewDelete(ViewSetTestMixin):
